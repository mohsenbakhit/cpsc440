...
\title{Cross-National Legislative Success Prediction:\\
Do Learned Features Generalize Across Legislative Systems?}
...
\author{
  Mohsen Bakhit (mobak13@student.ubc.ca) \\
  \and
  Tamzeed Quazi (quazi12@student.ubc.ca) \\
  \and
  Arman Thariani (armant@student.ubc.ca) \\
}
